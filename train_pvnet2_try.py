...
def main():
    ...
    if config.pv_net.train.iter_train == False:
        ...
        print ('iter')
        lr_scheduler_fc = torch.optim.lr_scheduler.StepLR(optimizer_fc, 4, 0.3)
        lr_scheduler_all = torch.optim.lr_scheduler.StepLR(optimizer_all, 4, 0.3)
